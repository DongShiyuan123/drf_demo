...
# 5.自定义校验方法，写在validators=[check_bpub_date]前。需求: 添加的书籍的日期不能小于2015年
...
class HeroInfoSerializer(serializers.Serializer):
    ...
    # hbook = serializers.PrimaryKeyRelatedField(read_only=True)  # hbook = 关联外键id
    # hbook = serializers.PrimaryKeyRelatedField(queryset=BookInfo.objects.all()) # 同上
